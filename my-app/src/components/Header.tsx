...
const Header = ({ activeSection, onLogout, onSearch }: HeaderProps) => {
  ...
  const notifications = [
    { id: 1, message: "New patient appointment scheduled", time: "2 mins ago", type: "info" },
    { id: 2, message: "Treatment session completed", time: "1 hour ago", type: "success" },
    { id: 3, message: "Staff member on leave", time: "3 hours ago", type: "warning" },
  ];
